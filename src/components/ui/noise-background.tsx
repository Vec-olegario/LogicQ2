...
export const NoiseBackground = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "group relative overflow-hidden rounded-2xl bg-neutral-100 p-1.5 backdrop-blur-sm dark:bg-neutral-800 transition-colors duration-500",
    ...
    >
      ...
      {/* Top gradient strip */}
      <motion.div
        className="absolute inset-x-0 top-0 h-1 rounded-t-2xl opacity-80 blur-sm transition-all duration-500"
        style={{
